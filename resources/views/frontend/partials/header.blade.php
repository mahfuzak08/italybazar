                        ...
                        <form action="{{ route('front.products.index')}}">
                            <div class="header-top-dropdown dropdown-box-style">
                                ...
                                <div class="axil-search">
                                    ...
                                    <input type="search" class="placeholder product-search-input" name="q" id="search2" value="{{ request('q')??''}}" maxlength="128" placeholder="Looking for something?" autocomplete="off">
                                </div>
                            ...
                            <ul class="action-list">
                                ...
                                <li class="shopping-cart">
                                    <a href="{{ route('front.carts.index')}}?segment={{request()->segment(1)}}" class="cart-dropdown-btn">
                                        <span class="cart-count" style="background: #F85606 !important;">{{ getTotalCart()}}</span>
        ...
        <div class="axil-mainmenu">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-2">
                        <div class="header-action">
                            <a class="search_icon" data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
                                <i class="far fa-search"></i>
                            </a>
                        </div>
                    </div>
...
<!--                                      </a>-->
                            ...
                            <ul class="mainmenu">
                                <h4 >Categories <svg width="15px" height="15px" viewBox="0 -4.5 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
