        ...
        elseif($status == 'declined') {
         ...
         return Datatables::of($datas)
                            ...
                            ->editColumn('pay_amount', function (Order $data) {
                                return
                                $price = PriceHelper::showOrderCurrencyPrice(round(($data->pay_amount + $data->wallet_price) * $data->currency_value, 2),$data->currency_sign);
                                return $price;
