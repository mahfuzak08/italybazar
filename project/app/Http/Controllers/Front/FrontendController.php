...
// CURRENCY SECTION ENDS
    ...
    function updateFinalize(){
        ...
        if (!Schema::hasColumn('generalsettings', 'mercado_publish_key')){
            Schema::table('generalsettings', function($table) {
                $table->string("mercado_publish_key")->nullable();
            });
          }
    ...
    if (file_exists($actual_path."kingcommerce-updater-v4.1.zip")) {
        unlink($actual_path."kingcommerce-updater-v4.1.zip");
    }
