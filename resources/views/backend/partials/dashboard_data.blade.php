            ...
            <a href="{{ url('admin/products') }}">
                <div class="card-body py-2">
                    <div class="row align-items-center">
                        <div class="col-6">
                            <h5 class="text-light fw-normal mt-0 text-truncate" title="Campaign Sent"> Total Products
                            </h5>
    ...
    <div class="col-md-6 col-xl-3">
        <div class="card" style="background-color: #893CFB;">
            <div class="card-body py-2">
                <div class="row align-items-center">
                    <div class="col-12">
                        <h5 class="text-light fw-normal mt-0 text-truncate" title="Booked Revenue">This Month Revenue
                        </h5>
    ...
    <div class="col-md-6 col-xl-3">
        <div class="card" style="background-color: #893CFB;">
            <div class="card-body py-2">
                <div class="row align-items-center">
                    <div class="col-12">
                        <h5 class="text-light fw-normal mt-0 text-truncate" title="Booked Revenue">Last Month Revenue
                        </h5>
