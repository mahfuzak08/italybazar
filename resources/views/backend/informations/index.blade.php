                    ...
                    <div class="row mb-2">
                        ...
                        <div class="mt-2">
                            ...
                            @enderror
					                       ...
					                       <div class="col-md-6">
                        <div class="form-group">
                            <strong for="role">Site Favicon</strong>
                            <input type="file" id="favicon" class="form-control" name="favicon" placeholder="Site Favicon...">
                        </div>
                        <div class="mt-2">
                            <img src="{{ asset('uploads/img/'.$information->favicon) }}" height="100" width="100" id="preview_img"/>
                        </div>
                            @error('favicon')
                             <p class="text-danger">
                                 {{$message}}
                            ...
                            @enderror
					                       ...
					                       <div class="col-md-6">
                        <div class="form-group">
                            <strong for="role">OG Images</strong>
                            <input type="file" id="og_images" class="form-control" name="og_images" placeholder="OG Images...">
                        </div>
                        <div class="mt-2">
                            <img src="{{ asset('uploads/img/'.$information->og_images) }}" height="100" width="100" id="preview_img"/>
                        </div>
                            @error('og_images')
                             <p class="text-danger">
                                 {{$message}}
